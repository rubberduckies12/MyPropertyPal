  ...
  <>
    ...
    <main className="tos-container">
      ...
      <ul>
        ...
        <li>Landlord property information</li>
        <li>Tenant information</li>
        <li>Rental payment records</li>
      ...
      <ul>
        <li>Consent: When you explicitly give us permission to process your data.</li>
        <li>Contractual Necessity: To provide the services you have requested from us.</li>
      ...
      <ul>
        ...
        <li>To process and submit tax-related data in compliance with HMRC’s Making Tax Digital requirements</li>
        <li>To maintain accurate financial records and reports</li>
        <li>To contact you regarding your account, system updates, and service notifications</li>
        <li>To deliver customer support and resolve any issues</li>
      ...
      <ul>
        ...
        <li>Service Providers: We use trusted third parties for cloud hosting, payment processing, analytics, and technical support, all bound by strict confidentiality and data protection agreements.</li>
      ...
      <ul>
        <li>Right to Access – Obtain a copy of your personal data we hold.</li>
        ...
        <li>Right to Restrict Processing – Request we limit how we use your data.</li>
        <li>Right to Data Portability – Request transfer of your data to another provider.</li>
        <li>Right to Object – Object to processing based on legitimate interests or direct marketing.</li>
