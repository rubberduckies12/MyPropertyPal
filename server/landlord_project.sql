...
61	2	tommy	rowe	$2b$10$fMcW1zBpHrwkrdDhCrwq3.e/n3Zov2cHKT/DaldHakvxnx9a971yy	tommyrowe39@gmail.com	f
\.
...
1	1	1	\N	hey	2025-07-10 22:51:16.833988
6	2	61	\N	hey	2025-07-11 16:14:39.108167
7	2	1	\N	jfuygiy	2025-07-11 16:15:20.16247
\.
...
9	13	Gas Saftey	gas safety	2026-07-30	{0}
\.
...
1	9	0	2025-07-09 17:36:00.711646
\.
...
20	1	12	1000.00	uyguy	ious	2025-07-20	\N
\.
...
31	13	39	t	10000.00	2025-07-25	last_friday	\N	\N
\.
...
COPY public.rent_payment (id, property_id, tenant_id, amount, paid_on, method, reference, stripe_payment_intent_id, stripe_subscription_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.chat_message_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.chat_message_status_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.compliance_event_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.expense_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.incident_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.property_tenant_id_seq', 31, true);
...
SELECT pg_catalog.setval('public.tenant_id_seq', 39, true);
