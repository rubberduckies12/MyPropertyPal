...
CREATE TABLE public.property_tenant (
    ...
    CONSTRAINT chk_rent_due_date CHECK (((rent_due_date >= 1) AND (rent_due_date <= 31)))
);
...
19	2	test	test	$2b$10$duSv5GOWtltKv/cpxLTlc.x8eJjKAr/aA5fhJkHNjj0eR65VAP4e6	test@gmail.com	f
20	2	codie 	bundfuss	$2b$10$9LvMgrveCBuDN/gRGavH/e4wwra5yVQekrEESJdOciqFU5KDpt6Ai	ipugpiyu@gmail.com	f
21	2	john	doe	$2b$10$4/kH8m7w.1Lx60cdTZswTegWb.Qlhm0Ha2MGTmnWuswsY6G4Oecoq	jd@gmail.com	f
23	2	john	doe	$2b$10$sPSbQydOuRe4hPikY5pDqOlPgCmegdSp.8W5HarU867d7n1t.z1uW	jod@gmail.com	f
24	2	carly	rowe	$2b$10$gPlskn8DFO3sWSfRQi/fw.tR.XQNERFwdhH/QnD43vC7O66BNAlGy	crowe@gmail.com	f
25	2	test	tenant	$2b$10$NTfsgqT1SluxO9wNtjDLgu3luCvVpGbzcF6dJPlcKXe/pXSGjOhgO	tt@mail.com	f
26	2	tomy	row	$2b$10$u0x2GDwQQloFY1vpEJrNQ.CaY5VWn.VJS5rDg.SEKGf5myFozto9i	tr@gmail.com	f
29	2	chris	thomson	$2b$10$MiKX7luSUOqzGqN4Cnuvc.QHMu0zy4i5x/Nj.n8RoIcu2qtNFIKhO	tommyrowe28@gmail.com	f
47	2	Christopher	Thomson	$2b$10$4rJXP24YfJzJ12sEvqptLeBSgNoFf/RqcCbshUAi4X99dk0WRWxCO	rowetommy699@gmail.com	f
48	2	Tommy	Rowe	$2b$10$QO9cM8eQzOCeOZLg606bl.35VKh30VX1HGnUDiIcfwx7WTfbaOlq6	Tommyrowe39@gmail.com	f
\.
...
--
-- Data for Name: audit_log; Type: TABLE DATA; Schema: public; Owner: tommyrowe
--
...
--
-- Data for Name: compliance_event; Type: TABLE DATA; Schema: public; Owner: tommyrowe
--

COPY public.compliance_event (id, property_id, name, description, due_date, reminder_days) FROM stdin;
9	13	Gas Saftey	gas safety	2025-07-31	{90}
10	12	gs	gs	2025-07-10	{90}
\.


--
-- Data for Name: compliance_reminder_sent; Type: TABLE DATA; Schema: public; Owner: tommyrowe
--
...
--
-- Data for Name: expense; Type: TABLE DATA; Schema: public; Owner: tommyrowe
--
...
13	1	2	\N	\N	6	corsair close	portsmouth	hampshire	po138gf
12	1	2	\N	\N	6	test	test	test	test
\.
...
25	13	32	t	10000.00	28
26	12	33	t	10000.00	30
\.


--
-- Data for Name: rent_payment; Type: TABLE DATA; Schema: public; Owner: tommyrowe
--

COPY public.rent_payment (id, property_id, tenant_id, amount, paid_on, method, reference) FROM stdin;
\.


--
-- Data for Name: task; Type: TABLE DATA; Schema: public; Owner: tommyrowe
--
...
--
-- Data for Name: task_status; Type: TABLE DATA; Schema: public; Owner: tommyrowe
--
...
COPY public.tenant (id, account_id, is_pending, invite_token) FROM stdin;
1	6	t	\N
2	7	t	\N
3	8	t	\N
4	9	t	\N
...
--
-- Name: audit_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tommyrowe
--
...
SELECT pg_catalog.setval('public.calendar_event_status_id_seq', 15, true);
...
--
-- Name: compliance_event_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tommyrowe
--

SELECT pg_catalog.setval('public.compliance_event_id_seq', 10, true);


--
-- Name: compliance_reminder_sent_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tommyrowe
--

SELECT pg_catalog.setval('public.compliance_reminder_sent_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.document_type_id_seq', 25, true);


--
-- Name: expense_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tommyrowe
--

SELECT pg_catalog.setval('public.expense_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.incident_severity_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.property_id_seq', 15, true);
...
SELECT pg_catalog.setval('public.property_status_id_seq', 28, true);
...
SELECT pg_catalog.setval('public.property_tenant_id_seq', 26, true);


--
-- Name: rent_payment_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tommyrowe
--

SELECT pg_catalog.setval('public.rent_payment_id_seq', 16, true);


--
-- Name: task_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tommyrowe
--
...
--
-- Name: task_status_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tommyrowe
--
...
SELECT pg_catalog.setval('public.tenant_id_seq', 33, true);
